...
*** 旋转
    参考[[./AVL 树][AVL 树的旋转]], 差别在于红黑树持有父节点的指针.
...
* 参考:
  ...
  [[https://alrightchiu.github.io/SecondRound/red-black-tree-deleteshan-chu-zi-liao-yu-fixupxiu-zheng.html][Red Black Tree: Delete(刪除資料)與 Fixup(修正)]]
